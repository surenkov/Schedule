...
{
    [Description("Different course types in one classroom at a time")]
    class DifferentCourseTypesInClassroom : IConflictsChecker
    {
        ...
        public ConflictsViewModel TreeModel(IEnumerable<Models.Schedule> items)
        {
            ...
            foreach (var conflict in conflicts)
            {
                ...
                child.Description =
                    conflict.Schedule.Course + ", " +
                    conflict.Schedule.Type + ", " +
